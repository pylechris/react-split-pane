    ...
    value: function render() {
      ...
      return _react2.default.createElement('span', {
        ...
        onDoubleClick: function onDoubleClick(event) {
          ...
          _react2.default.createElement('div', {className: "handles"},
            _react2.default.createElement('div'),
            _react2.default.createElement('div', {className: "verticalHandleBody"},
              _react2.default.createElement('span', {className: "verticalHandleLine"}),
              _react2.default.createElement('span', {className: "verticalHandleLine"}),
              _react2.default.createElement('span', {className: "verticalHandleLine"})),
            _react2.default.createElement('div', {className: "horizontalHandleBody"},
              _react2.default.createElement('span', {className: "horizontalHandleLine"}),
              _react2.default.createElement('span', {className: "horizontalHandleLine"}),
              _react2.default.createElement('span', {className: "horizontalHandleLine"}))
